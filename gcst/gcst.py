...
def process(obj, d):
    obj.text(d)
    obj.pathData(d.blkdatapixels, d.height)
    obj.svgPath(d.blkdatapixels)
    obj.svgGraph(d.blkdataprop, d.height, d.width, d.svgid)
...
class Temp(object):
    ...
    def text(self, inn):
        ...
        self.vars.update(dict(
            ...
            minTempShift=0,
            maxTempShift=11 if d.foldedOrUnfolded=='unfolded0' else 60,
